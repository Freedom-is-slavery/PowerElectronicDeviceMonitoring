...
void Adc_Init(void)
{
	...
	ADC_InitStructure.ADC_ExternalTrigConvEdge = ADC_ExternalTrigConvEdge_None; //规则通道无外部触发
...
void DMA2_Init(void)
{
	...
	DMA_InitStructure.DMA_Memory0BaseAddr = (u32)(vu16 *)ADValue;	//DMA内存基地址
...
void Start_ADC_Conversion(void)
{
	...
	// {
	// 	ADValue[i] = (vu16)(ADValue[i] * 3.3 / 4096);	//电压值转换
	// } 
}
